...
public class BaseDatos extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String queryCrearTablaContacto = "CREATE TABLE " + ConstantesBaseDatos.TABLE_CONTACTS + "(" +
                                    ...
                                    ")";
        String queryCreatTablaLikesContacto = "CREATE TABLE " + ConstantesBaseDatos.TABLE_LIKES_CONTACTS + "(" +
                ...
                ConstantesBaseDatos.TABLE_LIKES_CONTACTS_NUMERO_LIKES + " INTEGER, " +
                "FOREIGN KEY ("+ ConstantesBaseDatos.TABLE_LIKES_CONTACTS_ID_CONTACTO +")"+
                "REFERENCES " + ConstantesBaseDatos.TABLE_CONTACTS + "("+ConstantesBaseDatos.TABLE_LIKES_CONTACTS_ID+")" +
                ")";
        db.execSQL(queryCrearTablaContacto);
        db.execSQL(queryCreatTablaLikesContacto);
    }
    ...
    public ArrayList<Contacto> obtenerTodosLosContactos () {
        ...
        while (registros.moveToNext()) {
            ...
            String queryLikes = "SELECT COUNT("+ConstantesBaseDatos.TABLE_LIKES_CONTACTS_NUMERO_LIKES+") AS LIKES" +
                    " FROM " + ConstantesBaseDatos.TABLE_LIKES_CONTACTS +
                    " WHERE " + ConstantesBaseDatos.TABLE_LIKES_CONTACTS_ID_CONTACTO +
    ...
    public int obtenerLikesContacto (Contacto contacto) {
        int likes =0;
        String query = "SELECT COUNT("+ConstantesBaseDatos.TABLE_LIKES_CONTACTS_NUMERO_LIKES+")" +
                " FROM " + ConstantesBaseDatos.TABLE_LIKES_CONTACTS +
                " WHERE " + ConstantesBaseDatos.TABLE_LIKES_CONTACTS_ID_CONTACTO +
                "=" + contacto.getId();
        SQLiteDatabase db = this.getWritableDatabase();
